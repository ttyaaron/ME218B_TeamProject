...
${OBJECTDIR}/ProjectSource/EncoderTestService.o: ProjectSource/EncoderTestService.c  .generated_files/flags/default/2102be4f34878f69be372368444d7c17422014b .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}/ProjectSource" 
	@${RM} ${OBJECTDIR}/ProjectSource/EncoderTestService.o.d 
	@${RM} ${OBJECTDIR}/ProjectSource/EncoderTestService.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SNAP=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -I"FrameworkHeaders" -I"ProjectHeaders" -fno-common -MP -MMD -MF "${OBJECTDIR}/ProjectSource/EncoderTestService.o.d" -o ${OBJECTDIR}/ProjectSource/EncoderTestService.o ProjectSource/EncoderTestService.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
	
${OBJECTDIR}/ProjectSource/TapeFollowFSM.o: ProjectSource/TapeFollowFSM.c  .generated_files/flags/default/7c192ad566b0b7e2b947bb30b4d0ec31cc87ad0b .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}/ProjectSource" 
	@${RM} ${OBJECTDIR}/ProjectSource/TapeFollowFSM.o.d 
	@${RM} ${OBJECTDIR}/ProjectSource/TapeFollowFSM.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SNAP=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -I"FrameworkHeaders" -I"ProjectHeaders" -fno-common -MP -MMD -MF "${OBJECTDIR}/ProjectSource/TapeFollowFSM.o.d" -o ${OBJECTDIR}/ProjectSource/TapeFollowFSM.o ProjectSource/TapeFollowFSM.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
...
${OBJECTDIR}/ProjectSource/EncoderTestService.o: ProjectSource/EncoderTestService.c  .generated_files/flags/default/9eab7009618412a65ec0b757074d3c332ce3a6d7 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}/ProjectSource" 
	@${RM} ${OBJECTDIR}/ProjectSource/EncoderTestService.o.d 
	@${RM} ${OBJECTDIR}/ProjectSource/EncoderTestService.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -I"FrameworkHeaders" -I"ProjectHeaders" -fno-common -MP -MMD -MF "${OBJECTDIR}/ProjectSource/EncoderTestService.o.d" -o ${OBJECTDIR}/ProjectSource/EncoderTestService.o ProjectSource/EncoderTestService.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
	
${OBJECTDIR}/ProjectSource/TapeFollowFSM.o: ProjectSource/TapeFollowFSM.c  .generated_files/flags/default/5e1978253dbf1a41d7457633f927f8b0e00a8633 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}/ProjectSource" 
	@${RM} ${OBJECTDIR}/ProjectSource/TapeFollowFSM.o.d 
	@${RM} ${OBJECTDIR}/ProjectSource/TapeFollowFSM.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -I"FrameworkHeaders" -I"ProjectHeaders" -fno-common -MP -MMD -MF "${OBJECTDIR}/ProjectSource/TapeFollowFSM.o.d" -o ${OBJECTDIR}/ProjectSource/TapeFollowFSM.o ProjectSource/TapeFollowFSM.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
